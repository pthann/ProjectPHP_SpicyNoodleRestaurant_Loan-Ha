      ...
      <section class="content container">
        <div class="d-flex justify-content-between">
          ...
          <form class="d-flex" method="GET">
            <input class="form-control me-2" type="search" name="search" placeholder="Search by Email, Name" id="searchUser" aria-label="Search">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" id="userEmailUpdate" required>
                  </div>
                  <div class="mb-3">
