            ...
            <section class="content container">
                <div class="d-flex justify-content-between">
                    ...
                    <form class="d-flex" method="GET">
                        <input class="form-control me-2" type="search" name="search" placeholder="Search by ID, Name"
                            id="searchFood" aria-label="Search">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $value["name"] ?></td>
                                <td><img src="<?= $value["image_link"] ?>" alt="<?= $value["name"] ?>" width="50px">
                                </td>
                                <td><?= $value["price"] ?></td>
                                <td><?= $value["description"] ?></td>
                                <td>
                                    <button
                                        onclick='showValueUpdateFood("<?= $value["id"] ?>","<?= $value["name"] ?>", "<?= $value["image_link"] ?>", "<?= $value["price"] ?>", "<?= $value["description"] ?>")'
                                        class="btn btn-info" data-bs-toggle="modal"
                                        data-bs-target="#updateFoodModal">Update</button>

                                    <button
                                        onclick='showMessageDeleteFood("<?= $value["id"] ?>","<?= $value["name"] ?>")'
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="image_link" id="foodImage"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" id="foodDescription"
                                            rows="3"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="foodNameUpdate"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="foodImageUpdate" class="form-label">Image Link:</label>
                                        <input type="text" class="form-control" name="image_link" id="foodImageUpdate"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="foodPriceUpdate" class="form-label">Price:</label>
                                        <input type="text" class="form-control" name="price" id="foodPriceUpdate"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="foodDescriptionUpdate" class="form-label">Description:</label>
                                        <textarea class="form-control" name="description" id="foodDescriptionUpdate"
                                            rows="3"></textarea>
                                    </div>
